...
from configs import PATIENCE, MAX_NUM_EPOCHS, NUM_RUNS, BATCH_SIZE, PINN_LEARNING_RATE, WEIGHT_DECAY, PINN_REAL_RESULTS_DIR, W_PINN_DIV_WEIGHT
...
for region_name in ["regionc"]:
    ...
    RESULTS_DIR = PINN_REAL_RESULTS_DIR
