...
from configs import PATIENCE, MAX_NUM_EPOCHS, NUM_RUNS, DFNGP_LEARNING_RATE, WEIGHT_DECAY, N_SIDE, DFNGP_RESULTS_DIR, SIGMA_N_RANGE, SIGMA_F_RANGE, L_RANGE,  STD_GAUSSIAN_NOISE
...
for sim_name, sim_func in simulations.items():
    ...
    for run in range(NUM_RUNS):
       ...
       ### Divergence: Total absolute divergence (sum divergence at each point, after summing dims)
        ...
        dfNGP_test_NLL = compute_NLL_full(y_test, mean_pred_test, covar_pred_test).item()
