...
# TODO: Delete overthonwrite, run full
NUM_RUNS = 5
...
for region_name in ["region_lower_byrd", "region_mid_byrd", "region_upper_byrd"]:
    ...
    for run in range(NUM_RUNS):
        ...
        dfGP2_train_sparse_NLL = compute_NLL_sparse(y_train, mean_pred_train, (covar_pred_train + torch.diag(train_noise_diag**2))).item()
        ...
        dfGP2_test_sparse_NLL = compute_NLL_sparse(y_test, mean_pred_test, (covar_pred_test + torch.diag(test_noise_diag**2))).item()
